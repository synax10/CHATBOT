...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","synax10")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","ASHWANI10")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","synax_chats")
...
SOURCE = 'https://github.com/synax10/CHATBOT/tree/main'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
